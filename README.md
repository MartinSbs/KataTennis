# Introduction
This is one of the solution to solve the following kata, using java.
...
# Requierements
* Cucumber:
If you want to use the cucumber test with the .feature, 
you need cucumber installed on your environment.
This test main focus is to adopt a behaviour point of view to test our component (Behavior Driven Development).
